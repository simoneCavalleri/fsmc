...
| **Dual-Paradigm Execution** | Synchronous continuous sampled loop (`step(in, out, srv)`) and asynchronous event-driven dispatch (`dispatch(ev, in, out, srv)`). | [Runtime C++ API](https://simoneCavalleri.github.io/fsmc/runtime_api/synchronous_fsm/) |
