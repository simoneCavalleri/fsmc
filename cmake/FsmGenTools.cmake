...
function(fsmc_target_sources TARGET_NAME)
    ...
    set(oneValueArgs NAME STANDARD NAMESPACE CONTEXT OUTPUT_DIR FORMAT)
    ...
    if(TARGET fsmc)
        ...
        set(FSMC_DEP fsmc)
    elseif(TARGET fsm-gen)
        set(FSMC_EXE "$<TARGET_FILE:fsm-gen>")
        set(FSMC_DEP fsm-gen)
    else()
        find_program(FSMC_EXE NAMES fsmc fsm-gen REQUIRED)
...
function(fsm_target_sources TARGET_NAME)
    fsmc_target_sources(${TARGET_NAME} ${ARGN})
endfunction()
