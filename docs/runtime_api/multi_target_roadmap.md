...
> [!IMPORTANT]
> **Active Production Target vs. Roadmap Previews**: As of version `v0.6.0`, the **C++ Reference Backend** (`C++17/C++20`) is the sole production-ready code generation target. The **Rust** (`no_std`) and **C** (`Embedded C`) backends described in this roadmap represent **preview specifications and RFC designs** currently scheduled for the `v0.7.0` milestone.
...
| :--- | :--- | :--- | :--- | :--- |
| **C++ Target** | C++17 / C++20 | Synchronous stack, Lock-Free SPSC, Active Object | Zero heap, zero vtable, $O(1)$ WCET | **Production (v0.6.0+)** |
