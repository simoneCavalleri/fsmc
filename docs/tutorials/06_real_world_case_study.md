...
// ----------------------------------------------------------------------------
int main() {
    // Policy-based instantiation — all domains resolved at compile time
    // UAVFlightControllerFSM is generated by fsmc as:
    //   using UAVFlightControllerFSM = ::fsm::make_fsm<
    //       UAVFlightControllerTable,
    //       ::fsm::with_ports<UAVFlightControllerInPorts, UAVFlightControllerOutPorts>,
    //       ::fsm::with_registers<UAVFlightControllerRegisters>,
    //       ::fsm::with_services<UAVFlightControllerServices>
    //   >;
    UAVFlightControllerRegisters reg{};
    UAVFlightControllerFSM fsm(reg);
    ...
    // 1. Arming Phase
    UAVFlightControllerInPorts in{.altitude_m = 0.0f, .battery_pct = 95.0f, .imu_healthy = true};
