...
using ConnectionSysmlFSM = fsm::fsm<ConnectionSysmlFSMTable, fsm::no_context, Disconnected>;
using ThreadSafeConnectionSysmlFSM = fsm::thread_safe_fsm<ConnectionSysmlFSMTable, fsm::no_context, Disconnected>;
