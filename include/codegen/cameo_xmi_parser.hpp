...
class CameoXmiParser : public IParser {
  ...
  private:
    ...
    void parse_state_machine_element(const std::shared_ptr<XmlNode>& parent_node, FsmModel& model,
    ...
    static void parse_transition_element(const std::shared_ptr<XmlNode>& trans_node, FsmModel& model,
                                         const std::string& /*current_parent_state*/,
