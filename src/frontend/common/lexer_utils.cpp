...
std::optional<std::string_view> LexerUtils::extract_bracketed(std::string_view str, char open_char, char close_char) {
...
std::optional<std::string_view> LexerUtils::extract_quoted(std::string_view str) {
    str = trim(str);
...
std::tuple<std::string, std::optional<std::string>, std::optional<std::string>> LexerUtils::parse_transition_label(
