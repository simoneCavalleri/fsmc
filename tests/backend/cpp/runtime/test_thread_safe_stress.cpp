...
struct LogStart {
    ...
    void operator()(const StartEvent& /*evt*/, const Src& /*src*/, Dst& /*dst*/, StressServices& srv) const noexcept {
        srv.total_starts.fetch_add(1, std::memory_order_relaxed);
    }
};
struct LogFinish {
    template <typename Src, typename Dst>
    void operator()(const FinishEvent& /*evt*/, const Src& /*src*/, Dst& /*dst*/, StressServices& srv) const noexcept {
        srv.total_finishes.fetch_add(1, std::memory_order_relaxed);
    }
};
struct LogSync {
    template <typename Src, typename Dst>
    void operator()(const SyncEvent& /*evt*/, const Src& /*src*/, Dst& /*dst*/, StressServices& srv) const noexcept {
        srv.total_syncs.fetch_add(1, std::memory_order_relaxed);
    }
};
struct LogPing {
    template <typename Src, typename Dst>
    void operator()(const PingEvent& /*evt*/, const Src& /*src*/, Dst& /*dst*/, StressServices& srv) const noexcept {
        srv.total_pings.fetch_add(1, std::memory_order_relaxed);
    }
};
