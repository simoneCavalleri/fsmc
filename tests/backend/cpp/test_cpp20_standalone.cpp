 ...
 * @scenario Instantiate generated C++20 ConnectionFSM20 state machine and dispatch synchronous and asynchronous events.
 * @expected State machine initializes, transitions accurately, processes asynchronous queues, and terminates without
 * error.
 */
